...
See [`examples/SubdivisionController_CutWithSurface.scn`](examples/SubdivisionController_CutWithSurface.scn).
...
| Scene | Shows | Try |
|--|--|--|
| [`SubdivisionController_CutFromPlane.scn`](examples/SubdivisionController_CutFromPlane.scn) | Cutting a beam along a plane, with the cut drawn before it is applied | `1` then `2` |
| [`SubdivisionController_CutWithSurface.scn`](examples/SubdivisionController_CutWithSurface.scn) | The same cut with `surfaceCut="1"`, and the scene structure that needs | `1` then `2` |
| [`SubdivisionController_RefineTetrahedra.scn`](examples/SubdivisionController_RefineTetrahedra.scn) | Refining three chosen tetrahedra and the neighbours that follow | `3` |
| [`SubdivisionController_RefineFullMesh.scn`](examples/SubdivisionController_RefineFullMesh.scn) | Refining the whole mesh | `4` |
