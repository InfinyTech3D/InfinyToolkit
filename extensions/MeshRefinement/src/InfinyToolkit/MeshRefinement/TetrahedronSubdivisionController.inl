...
TetrahedronSubdivisionController<DataTypes>::TetrahedronSubdivisionController()
    ...
    , d_refineCriteria(initData(&d_refineCriteria, SReal(0.0), "refineCriteria", "Fraction of the mesh mean tetrahedron volume under which a tetrahedron is not subdivided. 0 subdivides regardless of volume"))
