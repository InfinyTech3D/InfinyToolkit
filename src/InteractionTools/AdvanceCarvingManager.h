#ifndef SOFA_INTERACTIONTOOLS_ADVANCECARVINGMANAGER_H
#define SOFA_INTERACTIONTOOLS_ADVANCECARVINGMANAGER_H
...
#endif // SOFA_INTERACTIONTOOLS_ADVANCECARVINGMANAGER_H
