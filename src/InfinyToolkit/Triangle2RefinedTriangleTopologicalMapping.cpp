...
int Triangle2RefinedTriangleTopologicalMappingClass = core::RegisterObject("Special case of mapping where TriangleSetTopology is converted into a refined TriangleSetTopology")
...
void Triangle2RefinedTriangleTopologicalMapping::updateTopologicalMappingTopDown()
{
    ...
    while( itBegin != itEnd )
    {
        ...
        //            msg_warning() << "INFO_print : Triangle2RefinedTriangleTopologicalMapping - nb edges = " << ind_last;
        //        }
